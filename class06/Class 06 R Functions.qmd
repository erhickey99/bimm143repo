...
R maks writing functions accessible but we should always start by trying to get a working snippet of code first before we write our function.
...
I want to stop working with `student1`, `student2`, etc. and typing it out every time so let instead work in an input called `x`
